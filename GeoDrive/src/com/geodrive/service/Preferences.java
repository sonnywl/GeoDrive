...
public class Preferences extends PreferenceActivity {
    ...
    public static class PreferencesFragment extends PreferenceFragment {
        public static final String[] ACCOUNT_TYPE = new String[] {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mAccountPreference = findPreference("selected_account_preference");
        ...
        private void chooseAccount() {
            ...
            Intent intent =
                    AccountPicker.newChooseAccountIntent(getPreferenceAccount(), null,
                            ACCOUNT_TYPE, false,
                            null, null, null, null);
        ...
        private void setAccount(Account account) {
            if (account != null) {
                ...
                if (oldAccount != null) {
                    ContentResolver.setSyncAutomatically(oldAccount, "com.google.provider.NotePad",
                            false);
                }
                SharedPreferences.Editor editor =
                        PreferenceManager.getDefaultSharedPreferences(getActivity()).edit();
                editor.putString(SELECTED_ACCOUNT_USER, account.name);
                editor.commit();
        ...
        private void setSyncFrequency(Account account) {
            if (account != null) {
                String syncValue = mPreferences.getString(SYNC_PREFERENCE, "900");

                mSyncPreference
                        .setSummary("Sync every "
                ...
                ContentResolver.addPeriodicSync(account, "com.google.provider.NotePad",
                        new Bundle(),
